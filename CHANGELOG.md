...
- Dependency security scanning using [Socket](https://socket.dev/) and Bun Security Scanner API.
- Platform-specific optional dependency installation for CI/CD workflows to speed up job execution.

### Changed

- The project structure and documentation now organise related types and functions into specific modules.
...
[Unreleased]: https://github.com/zhelvis/structure-ts/compare/v1.1.0...HEAD
